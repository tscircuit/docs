...
description: Learn how to build a simple USB-powered flashlight circuit using tscircuit with a USB-C connector, push button, LED, and resistor. Perfect for learning component placement, net connections, and basic PCB design.
---
...
// Simple USB flashlight: USB-C provides VBUS, pushbutton switches VBUS
// through R1 into LED. Compact single-layer example for quick prototyping.
import { SmdUsbC } from "@tsci/seveibar.smd-usb-c"

export default () => (
  <board width="12mm" height="30mm">
    {/* USB-C connector mapped to nets */}
    <SmdUsbC
      name="J1"
    ...
    {/* Momentary pushbutton tying VBUS to R1.pos when pressed */}
