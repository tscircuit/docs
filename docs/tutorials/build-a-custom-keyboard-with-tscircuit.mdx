...
We'll be using a Raspberry Pi Pico as the microcontroller, Cherry MX-style key switches, and standard diodes for the matrix.
...
2.  **Key Switches:** The physical buttons you press. We'll use a generic Cherry MX footprint component.
...
### Hot-Swappable Key Switch (3-pin Cherry MX Style)
