...
- High-quality decoupling capacitors to minimize audio noise
...
export default () => (
  <RaspberryPiHatBoard name="HAT1">
    ...
    <chip
      ...
      pinLabels={{
        pin1: ["OUTL+"], pin2: ["PGNDL"], pin3: ["OUTL-"], pin4: ["PVDDL"],
        pin5: ["MUTE"], pin6: ["VDD"], pin7: ["INL"], pin8: ["VREF"],
        pin9: ["NC"], pin10: ["INR"], pin11: ["GND"], pin12: ["SHDN"],
        pin13: ["PVDDR"], pin14: ["OUTR-"], pin15: ["PGNDR"], pin16: ["OUTR+"]
      }}
      pcbX={0}
      pcbY={0}
    />

    {/* Dual Potentiometer for Volume Control (represented as two SIP3 headers for simplicity) */}
    ...
    <capacitor name="C5" capacitance="10uF" footprint="0805" pcbX={5} pcbY={10} />
    <capacitor name="C6" capacitance="0.1uF" footprint="0603" pcbX={5} pcbY={5} />
    ...
    <trace from=".HAT1_chip .V5_1" to=".U1 .PVDDL" />
    <trace from=".HAT1_chip .V5_1" to=".U1 .PVDDR" />
    <trace from=".HAT1_chip .GND_1" to=".U1 .GND" />
    <trace from=".HAT1_chip .GND_1" to=".U1 .PGNDL" />
    <trace from=".HAT1_chip .GND_1" to=".U1 .PGNDR" />

    {/* Decoupling capacitor connections */}
    <trace from=".C5 > .pin1" to=".HAT1_chip .V5_1" />
    <trace from=".C5 > .pin2" to=".HAT1_chip .GND_1" />
    <trace from=".C6 > .pin1" to=".HAT1_chip .V5_1" />
    <trace from=".C6 > .pin2" to=".HAT1_chip .GND_1" />

    {/* Pull MUTE and SHDN High for Normal Operation */}
    ...
    <trace from=".RV1 > .pin3" to=".HAT1_chip .GND_1" />
    ...
    <trace from=".RV2 > .pin3" to=".HAT1_chip .GND_1" />
...
- **Decoupling Capacitors:** 10µF and 0.1µF capacitors are connected close to the PAM8403's supply pins to filter out voltage noise from the Pi's power rails.
