...
### Passive Buzzer
This guide uses the [KINGSTATE KMTG1203](https://jlcpcb.com/partdetail/KINGSTATE-KMTG1203/C7421651), a 5V, 12mm × 12mm SMD piezo buzzer available from JLCPCB as part `C7421651`. The `jlcpcb:C7421651` reference loads its EasyEDA footprint, while `cadModel` loads the matching 3D model from the tscircuit Model CDN.
