...
export const kmtg1203Source = `import type { ChipProps } from "@tscircuit/props"
...
export const KMTG1203 = (props: ChipProps<typeof pinLabels>) => (
  <chip
    pinLabels={pinLabels}
    ...
    footprint={
      <footprint>
        ...
        <smtpad
          ...
          shape="rect"
        />
        <silkscreenrect width="12mm" height="12mm" />
        <silkscreentext
          text="{NAME}"
          pcbX="0mm"
          pcbY="6.9944mm"
    ...
    cadModel={{
      ...
      stepUrl:
        "https://modelcdn.tscircuit.com/easyeda_models/assets/C7421651.step?uuid=2fd2bce55e664e4a90f7bd6f5ef4d817",
      pcbRotationOffset: 0,
      modelOriginPosition: {
...
export const withKmtg1203 = (indexSource) => ({
  "index.tsx": indexSource,
  "KMTG1203.tsx": kmtg1203Source,
})

<TscircuitIframe defaultView="3d" entrypoint="index.tsx" fsMap={withKmtg1203(`
import { RaspberryPiHatBoard } from "@tscircuit/common"
import { KMTG1203 } from "./KMTG1203"

export default () => (
  <RaspberryPiHatBoard name="HAT1">
    {/* 5V passive piezo buzzer from JLCPCB */}
    <KMTG1203 name="BZ1" pcbX={18} pcbY={5} />
...
- Use a transistor to switch the 5V buzzer from a 3.3V GPIO signal
- Include a current-limiting resistor for the transistor base

## Understanding the Components

### Passive Buzzer
This guide uses the [KINGSTATE KMTG1203](https://jlcpcb.com/partdetail/KINGSTATE-KMTG1203/C7421651), a 5V, 12mm × 12mm SMD piezo buzzer available from JLCPCB as part `C7421651`. The imported component includes the part's two-pad EasyEDA footprint and 3D model.
...
### NPN Transistor (2N2222)
The NPN transistor acts as a low-side switch, allowing the 3.3V GPIO signal to control the buzzer from the 5V rail.
...
<CircuitPreview splitView={false} hidePCBTab hide3DTab defaultView="schematic" entrypoint="index.tsx" fsMap={withKmtg1203(`
import { RaspberryPiHatBoard } from "@tscircuit/common"
import { KMTG1203 } from "./KMTG1203"
...
<CircuitPreview hidePCBTab hide3DTab defaultView="schematic" entrypoint="index.tsx" fsMap={withKmtg1203(`
import { RaspberryPiHatBoard } from "@tscircuit/common"
import { KMTG1203 } from "./KMTG1203"
...
<CircuitPreview hide3DTab defaultView="pcb" entrypoint="index.tsx" fsMap={withKmtg1203(`
import { RaspberryPiHatBoard } from "@tscircuit/common"
import { KMTG1203 } from "./KMTG1203"
