...
- **inductance** - The inductance value specified as a string e.g. `"10µH"`, `"100nH"`, or `"1mH"`
- **maxCurrentRating** - Maximum current the inductor can handle e.g. `"500mA"` or `"2A"`
...
| `inductance` | The inductance value of the inductor. Can be a string with units or a number in Henrys. | `"10µH"`, `"100nH"` |
