...
<CircuitPreview
  ...
  code={`
  export default () => (
    <switch name="SW1" type="spst" footprint="kicad:Button_Switch_SMD/SW_SPST_B3S-1000" />
  )
  `}
/>
...
<CircuitPreview
  ...
  export default () => (
    <group>
      <switch name="SW1" type="spst" schX={-1} schY={-1} footprint="kicad:Button_Switch_SMD/SW_SPST_B3S-1000" />
      <switch name="SW2" type="spdt" schX={1} schY={-1} footprint="kicad:Button_Switch_SMD/SW_SPDT_PCM12" />
      <switch name="SW3" type="dpst" schX={-1} schY={1} footprint="kicad:Button_Switch_SMD/SW_DIP_SPSTx02_Slide_6.7x6.64mm_W8.61mm_P2.54mm_LowProfile" />
      <switch name="SW4" type="dpdt" schX={1} schY={1} footprint="kicad:Button_Switch_SMD/SW_DPDT_CK_JS202011JCQN" />
    </group>
  )
  `}
/>
