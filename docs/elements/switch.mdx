...
<CircuitPreview
  ...
  export default () => (
    <group>
      ...
      <switch name="SW3" type="dpst" schX={-1} schY={1} footprint="kicad:Button_Switch_SMD/SW_SPST_B3S-1000" />
      <switch name="SW4" type="dpdt" schX={1} schY={1} footprint="kicad:Button_Switch_SMD/SW_DPDT_PCM12" />
    </group>
  )
  `}
/>
