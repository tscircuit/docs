...
To enable cloud parallelism without changing autorouter outputs, set
[`platformConfig.useCloudAutorouter`](../guides/running-tscircuit/platform-configuration.md#cloud-autorouting)
in your project configuration. This platform option applies to eligible
Pipeline9 routing at the default `"1x"` effort level.
