...
| `outline` | `BoardOutlinePoint[]` | Supply a custom polygon. A point can define a castellated hole with `isCastellatedHole`, required `holeDiameter` and `padDiameter`, and optional `connectsTo`. |
