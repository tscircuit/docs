...
| `automaticPoursEnabled` | `boolean` | Generate implicit pours for eligible power nets when routing is enabled. Defaults to `false`; use `<copperpour />` for explicit control. |
