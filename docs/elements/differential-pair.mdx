...
export const usbDifferentialPairExample = `export default () => (
  <board width="26mm" height="14mm">
    <connector
      ...
      pcbRotation={-90}
    />
    <testpoint name="TP_DP" pcbX={9} pcbY={2.5} padDiameter="1.2mm" />
    <testpoint name="TP_DM" pcbX={8} pcbY={-2.5} padDiameter="1.2mm" />
...
- The center meander makes the route-length correction visible.
