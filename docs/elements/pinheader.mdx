...
| connectsFromAbove | boolean | false | Mounts the header on the top layer, describing a mating connector that approaches from above. |
| connectsFromBelow | boolean | false | Mounts the header on the bottom layer, describing a mating connector that approaches from below. |
