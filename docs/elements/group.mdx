...
External components connect to public ports without referencing internal
component names:
...
<resistor
  ...
  resistance="1k"
  footprint="0402"
  connections={{ pin1: "net.ROW1_CONTROL", pin2: "MATRIX.ROW1" }}
/>
```

Use `GROUP_NAME.PORT_NAME` selectors such as `MATRIX.ROW1`; internal names such
as `D1` remain encapsulated.
