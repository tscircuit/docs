...
| `schPinStyle` | `SchematicPinStyle` | No | Per-pin margins keyed by local pin number or label. Styles inherit from the referenced chip and merge field by field; use `0` to clear an inherited margin. |
