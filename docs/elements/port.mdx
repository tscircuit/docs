...
| `schPinLabelFontSize` | `"default" \| "sm" \| distance` | Sets this port's schematic pin-label size. `"sm"` resolves to `0.12`; a positive distance sets an exact size; `"default"` preserves the renderer default. |
