...
| `schPinLabelFontSize` | `"default" \| "sm" \| distance` | Size of this port's schematic pin label. `"sm"` is `0.12` schematic units; a positive distance sets an exact size; `"default"` (or omitting the prop) keeps the renderer default. |
