...
The easiest way to order your prototypes is through the tscircuit platform, which handles the entire ordering process for you. Here's how it works:
...
<figcaption>The order button is prominently displayed on your project's view packages page</figcaption>
</figure>
