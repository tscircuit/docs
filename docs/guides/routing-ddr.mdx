...
They are outside the breakout. Because each trace crosses the breakout
boundary, tscircuit creates the breakout points automatically and the winding
solver distributes them along the requested side in bus order.
