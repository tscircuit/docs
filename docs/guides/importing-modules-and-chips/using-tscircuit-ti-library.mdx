...
## Generate Schematics from System Blocks

To integrate these modules into a block designer, see
[Generate Schematics from System Blocks](../circuit-generation/system-blocks-to-schematics.mdx)
for a block-to-TSX exporter and the resulting schematic.
