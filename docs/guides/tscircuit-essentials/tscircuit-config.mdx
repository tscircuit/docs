...
Explicit CLI options override these defaults; CLI net selectors replace the
configured list. During X-Ray, non-copper layers are hidden even if enabled here.
