...
The `inBom`, `exclude_from_bom`, and properties like `Value` and `Description` are used when generating bills of materials.

### Documentation

Properties like `Datasheet` and `Description` provide valuable documentation that travels with your component definitions.
