...
<video
  ...
  playsInline
  preload="metadata"
  poster="https://cdn.jsdelivr.net/gh/tscircuit/usage-video@main/outputs/tscircuit-usage-video-poster.png"
  style={{ width: "100%", borderRadius: "12px" }}
>
  <source
    src="https://cdn.jsdelivr.net/gh/tscircuit/usage-video@main/outputs/tscircuit-usage-video.mp4"
    type="video/mp4"
  />
  <a href="https://github.com/tscircuit/usage-video/blob/main/outputs/tscircuit-usage-video.mp4">
    Watch the tscircuit AI usage video on GitHub.
  </a>
</video>
