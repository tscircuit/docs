...
than typing out a [port selector](./port-selectors.md).
...
[port selectors](./port-selectors.md). Where possible, it's much better to use [component hooks](./component-hooks.md)
