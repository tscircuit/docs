...
Commands have a separate copy button; output remains selectable. Long lines scroll
...
A transcript has an optional `title`, optional `caption`, and `sessions` containing
